...
function runJsonl({ cmd, args, workdir, parse, onLine, onChild, onUsage, input, timeoutScale }) {
  return new Promise((resolve) => {
    ...
    const T = require('./steptimeout').arm(p, timeoutScale); // session 连续开发会话按阶段数放大超时
